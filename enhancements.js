(function() {
  ...
  function addWishlistHearts() {
    ...
    cards.forEach(function(wrap) {
      ...
      var datesEl = wrap.querySelector('.new_r-item-dates');
  ...
  function renderWishlistFooter(list) {
    ...
    shareRow.className = 'zebra-wishlist-share-row';

    // Copy button
    var copyBtn = document.createElement('button');
    copyBtn.className = 'zebra-wishlist-share-btn zebra-share-copy';
    copyBtn.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg> Copiază';
    copyBtn.addEventListener('click', function() {
      var text = buildShareText(list);
      if (navigator.clipboard && navigator.clipboard.writeText) {
        navigator.clipboard.writeText(text).then(function() {
          showWishlistToast('Copiat în clipboard!');
          copyBtn.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg> Copiat!';
          setTimeout(function() {
            copyBtn.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg> Copiază';
          }, 2000);
        });
    ...
    waBtn.className = 'zebra-wishlist-share-btn zebra-share-whatsapp';
    waBtn.target = '_blank';
    waBtn.rel = 'noopener';
    waBtn.href = 'https://wa.me/?text=' + encodeURIComponent(buildShareText(list));
