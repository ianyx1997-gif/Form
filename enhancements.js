(function() {
  ...
  function addExpertButton() {
    ...
    var msg = 'Buna ziua! Sunt interesat de acest tur:\n\n';
    msg += 'Hotel: ' + hotelName + '\n';
    if (geo) msg += 'Locatie: ' + geo + '\n';
    if (price) msg += 'Pret: ' + price + '\n';
    if (dates) msg += 'Data: ' + dates + '\n';
    if (nightsEl) msg += 'Nopti: ' + nightsEl + '\n';
    if (food) msg += 'Masa: ' + food + '\n';
    if (rating) msg += 'Rating: ' + rating + '\n';
    msg += window.location.href + '\n';
    msg += '\nAs dori mai multe detalii. Ma puteti ajuta?';
  ...
  function buildShareText(list) {
    ...
    list.forEach(function(tour, i) {
      ...
      text += '\n';
      if (tour.geo) text += '   Loc: ' + tour.geo + '\n';
      if (tour.food) text += '   Masa: ' + tour.food + '\n';
      if (tour.dates) text += '   Data: ' + tour.dates + '\n';
      if (tour.price) text += '   Pret: ' + tour.price + '\n';
      if (tour.rating) text += '   Rating: ' + tour.rating + '\n';
      if (tour.link) text += '   ' + tour.link + '\n';
      text += '\n';
    });
    text += 'Descopera si tu pe zebratur.md';
    return text;
  }
  ...
  function renderWishlistFooter(list) {
    ...
    var expertText = 'Buna ziua! Am selectat cateva hoteluri si as dori ajutorul dvs. pentru a alege cea mai buna varianta:\n\n';
    list.forEach(function(tour, i) {
